...
public class Sudoku {
	 ...
	 *
	 * @param dim size of one block of the puzzle. For example, new Sudoku(3)
	 ...
	 *
	 * @param square digits or blanks of the Sudoku grid. square[i][j] represents
	 ...
	 *               ...3
	 *               41.2
	 * @param dim    dimension of puzzle Requires that dim*dim == square.length ==
	 ...
	 *
	 * @param dim      Dimension of puzzle. Requires: at most dim of 3, because
